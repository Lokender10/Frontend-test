  ...
  return (
   ...
   <Container>
     ...
     <div className="right-top">
      ...
      <img className="img1" src={img1} alt="profile" style={{width: 40, height: 40,borderRadius:"100px"}}/>
      <img className="img2" src={img2} alt="profile" style={{width: 40, height: 40,borderRadius:"100px"}}/>
